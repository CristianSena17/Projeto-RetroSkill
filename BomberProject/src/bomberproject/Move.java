...
public class Move implements Runnable{
    ...
    public static int xl=64,yl=64;
    
    public static int compx=64,compy=64;
    ...
    public void run() {
        ...
        if(left&&!right){
             xl=xl-paco;
             BomberProject.tela.TP1.setIcon(new ImageIcon(getClass().getResource("tank/TANKRED/left 1.png")));
             BomberProject.tela.sight='L';
                compara();
                    if(xl<64){
                        xl=64;}
            ...
            Thread.sleep(20);} 
                ...
                if(right){
                    xl=xl+paco;
                    BomberProject.tela.TP1.setIcon(new ImageIcon(getClass().getResource("tank/TANKRED/right 1.png")));
                    BomberProject.tela.sight='R';
                    compara();
                        if(xl>448){
                            xl=448;}
                Thread.sleep(20);   
        ...
        if(up&&!down){
             yl=yl-paco; 
             BomberProject.tela.TP1.setIcon(new ImageIcon(getClass().getResource("tank/TANKRED/up 1.png")));
             BomberProject.tela.sight='U';
            compara();
                if(yl<64){
                    yl=64;}
            Thread.sleep(20);}  
                ...
                if(down){
                    yl=yl+paco;
                    BomberProject.tela.TP1.setIcon(new ImageIcon(getClass().getResource("tank/TANKRED/down 1.png")));
                    BomberProject.tela.sight='D';
                    compara();
                        if(yl>448){
                            yl=448;}
                Thread.sleep(20);   
